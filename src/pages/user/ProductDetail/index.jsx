...
const ProductDetailPage = ({ match, ...props }) => {
  ...
  return (
    <>
      {productDetail.loading && commentList.loading ? (
        <Loading load={productDetail.loading && commentList.loading} />
      ) : (
        <>
          <TopWrapper
                      ...
                      <S.ProductImageWrapper>
                        ...
                        {isOpen && (
                          <Lightbox
                            ...
                            onMoveNextRequest={() =>
                              setImageIndex(
                                (imageIndex + 1) % imagesList.length
                              )
                            }
                          />
                        )}
                ...
                <Col sm={24} md={14}>
                  ...
                  <Row>
                    ...
                    <Col xs={24} sm={8} md={24} lg={8}>
                      <p>
                        Nhà xuất bản:{" "}
                        <b>{productDetail.data?.publisher?.name}</b>
                      </p>
                      <p>
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        if (current.clientHeight > 500) {
                          current.style.height = "500px";
                          current.children[1].style.display = "block";
                          loadMoreElement.current.innerText =
                            "Xem thêm nội dung";
                        } else {
                          current.style.height = "fit-content";
                          current.children[1].style.display = "none";
                  ...
                  <S.ProductDetailWrapper style={{ width: "100%" }}>
                    ...
                    >
                      {userInfo.data.id && (
                        <Comment
                          avatar={
                            <Avatar src={userInfo.data.avatar} alt="Avatar" />
                          }
                          content={
                            <Form
                              form={commentForm}
